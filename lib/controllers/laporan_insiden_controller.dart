...
import '../data/services/laporan_insiden_service.dart';

class LaporanInsidenController {
  final PagingController<int, LaporanInsidenModel> pagingController =
  ...
  Future<void> fetchPage(int pageKey) async {
    final result = await LaporanInsidenService().getLaporanInsiden(
      page: pageKey,
