...
import '../data/services/non_aktif_service.dart';

class NonAktifController {
  final PagingController<int, NonAktifModel> pagingController =
  ...
  Future<void> fetchPage(int pageKey) async {
    final result = await NonAktifService().getNonAktif(
      page: pageKey,
    ...
    result.fold(
      ...
      (data) {
        ...
        final newItems = data.listNonAktif;
