...
import '../data/services/nilai_risiko_service.dart';

class NilaiRisikoController {
  final PagingController<int, NilaiRisikoModel> pagingController =
  ...
  Future<void> fetchPage(int pageKey) async {
    final result = await NilaiRisikoService().getNilaiRisiko(
      page: pageKey,
