...
import 'package:arise/data/services/rekap_nilai_service.dart';
...
class RekapNilaiController {
  final PagingController<int, RekapNilaiModel> pagingController =
  ...
  Future<void> fetchPage(int pageKey) async {
    final result = await RekapNilaiService().getRekapNilai(
      page: pageKey,
    ...
    result.fold(
      ...
      (data) {
        ...
        final newItems = data.listRekapNilai;
