...
class RekapNilaiService {
  Future<Either<String, DashboardRekapNilai>> getRekapNilai({
    required int page,
    int? dinasId,
    String? startDate,
    String? endDate,
    ...
    try {
      String url =
          '$baseUrl/api/laporan/asset/rekap-nilai?page=$page&per_page=1000';
      if (dinasId != null) {
      ...
      print('Status Code (getRekapNilai : $page) : ${res.statusCode}');
      if (res.statusCode == 200) {
        return Right(
          DashboardRekapNilai.fromJson(jsonDecode(res.body)['data']),
        );
