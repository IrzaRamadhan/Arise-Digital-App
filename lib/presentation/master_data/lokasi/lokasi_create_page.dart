...
class LokasiCreatePage extends StatefulWidget {
  const LokasiCreatePage({super.key});

  @override
  State<LokasiCreatePage> createState() => _LokasiCreatePageState();
}

class _LokasiCreatePageState extends State<LokasiCreatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Tambah Lokasi')),
      body: Form(
        key: _formKey,
        child: ListView(
