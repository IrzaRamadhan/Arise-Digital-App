...
class SubKategoriEditPage extends StatefulWidget {
  final SubKategoriModel vendor;
  const SubKategoriEditPage({super.key, required this.vendor});

  @override
  State<SubKategoriEditPage> createState() => _SubKategoriEditPageState();
}

class _SubKategoriEditPageState extends State<SubKategoriEditPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Edit Sub Kategori')),
      body: Form(
        key: _formKey,
        child: ListView(
          ...
          child: BlocProvider(
            ...
            child: BlocConsumer<SubKategoriBloc, SubKategoriState>(
              listener: (context, state) {
                if (state is SubKategoriUpdated) {
