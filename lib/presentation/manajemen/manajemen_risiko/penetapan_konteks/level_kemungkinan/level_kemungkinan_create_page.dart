...
class LevelKemungkinanCreatePage extends StatefulWidget {
  const LevelKemungkinanCreatePage({super.key});

  @override
  State<LevelKemungkinanCreatePage> createState() =>
      _LevelKemungkinanCreatePageState();
}

class _LevelKemungkinanCreatePageState
    extends State<LevelKemungkinanCreatePage> {
          ...
          child: BlocProvider(
            ...
            child: BlocConsumer<LevelKemungkinanBloc, LevelKemungkinanState>(
              listener: (context, state) {
                if (state is LevelKemungkinanCreated) {
