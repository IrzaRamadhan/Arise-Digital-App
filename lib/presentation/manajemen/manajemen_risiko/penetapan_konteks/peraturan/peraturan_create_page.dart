...
class PeraturanCreatePage extends StatefulWidget {
  const PeraturanCreatePage({super.key});

  @override
  State<PeraturanCreatePage> createState() => _PeraturanCreatePageState();
}

class _PeraturanCreatePageState extends State<PeraturanCreatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Tambah Peraturan Risiko')),
      body: Form(
        key: _formKey,
        child: ListView(
