...
class LevelDampakCreatePage extends StatefulWidget {
  const LevelDampakCreatePage({super.key});

  @override
  State<LevelDampakCreatePage> createState() => _LevelDampakCreatePageState();
}

class _LevelDampakCreatePageState extends State<LevelDampakCreatePage> {
          ...
          child: BlocProvider(
            ...
            child: BlocConsumer<LevelDampakBloc, LevelDampakState>(
              listener: (context, state) {
                if (state is LevelDampakCreated) {
