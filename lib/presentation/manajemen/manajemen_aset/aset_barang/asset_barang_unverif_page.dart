...
class AssetBarangUnverifPage extends StatefulWidget {
  final int? initialIndex;
  const AssetBarangUnverifPage({super.key, this.initialIndex});

  @override
  State<AssetBarangUnverifPage> createState() => _AssetBarangUnverifPageState();
}

class _AssetBarangUnverifPageState extends State<AssetBarangUnverifPage>
  ...
  void initState() {
    ...
    _baruController =
        AssetController()
          ..initFilter(initType: 'barang', initVerifType: 'asset_baru');
    _penonaktianController =
        AssetController()
          ..initFilter(initType: 'barang', initVerifType: 'penonaktifan');
    _penghapusanController =
        AssetController()
          ..initFilter(initType: 'barang', initVerifType: 'penghapusan');
          ...
          return AsetBarangCard(
            ...
            onDetail: () {
              NavigationHelper.push(
                context,
                AsetBarangDetailPage(id: asset.id),
              );
            },
          );
        },
